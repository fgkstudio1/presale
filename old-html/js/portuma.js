...
const sttabi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_minInvest', type: 'uint256' },
      { internalType: 'uint256', name: '_maxInvest', type: 'uint256' },
...
const claimTokenAmount = async () => {
  try {
    ...
    let claimTokenAmount = sttcontract.methods
      .tokenToClaim(addr)
      .call()
...
const getAirdrop = async () => {
  ...
  if (fresh === '') fresh = '0x399215D4d913812A5E4B517f61fF618B65f22ec1';
...
function getreflink() {
  document.getElementById('refaddress').value =
    'https://maxima.cash/presale/?ref=' + document.getElementById('refaddress').value;
